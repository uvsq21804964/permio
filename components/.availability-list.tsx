...
export function AvailabilityList() {
  ...
  useEffect(() => {
    ...
    return () =>
      window.removeEventListener('availability-added', handleAvailabilityAdded);
  }, []);
    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          ...
          {availabilities.length !== 1 ? 'x' : ''} disponible
              ...
              >
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    ...
                    <Badge
                      variant={
                        availability.user.role === 'instructor'
                          ? 'default'
                          : 'secondary'
                      }
                    >
                  ...
                  <p className="text-muted-foreground text-sm">
                    {DAYS[availability.dayOfWeek]} • {availability.startTime} -{' '}
